...
const Testimonial = () => {
    ...
    return (
        <div
            ref={sectionRef}
            className="w-full py-16 md:py-20 bg-white px-4 md:px-8 min-h-screen flex items-center"
        >
            <div className="max-w-7xl mx-auto w-full">
                <div className="flex flex-col lg:flex-row gap-8 md:gap-12 lg:gap-16">
                    ...
                    >
                        <h1 className="text-amber-500 text-2xl md:text-3xl font-bold font-inria">
                            Client Testimonials
                        </h1>
                        <p className="text-3xl md:text-4xl font-normal font-inria leading-tight">
                            Hear from our <br className="hidden md:block" />
                            clients about their <br className="hidden md:block" />
                            experiences.
                        </p>
                        ...
                        <div className="hidden md:block mt-8">
                            ...
                            {/* <p className="text-gray-600">
                                Trusted by businesses and individuals for exceptional legal services.
                            </p> */}
                        </div>
                    </div>
                    ...
                    >
                        <div className="relative h-[500px] md:h-[550px] lg:h-[600px] overflow-hidden">
                            ...
                            <button
                                onClick={prevSlide}
                                className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 md:w-12 md:h-12 rounded-full bg-white shadow-lg flex items-center justify-center text-amber-500 hover:bg-amber-500 hover:text-white transition-all duration-300 transform hover:scale-110"
                                ...
                                {testimonials.map((testimonial, index) => (
                                    ...
                                    >
                                        <div className="h-full flex flex-col lg:flex-row gap-6 md:gap-8">
                                            {/* Image */}
                                            <div className="w-full lg:w-2/5 h-64 md:h-72 lg:h-full bg-gray-100 rounded-xl overflow-hidden shadow-md">
                                                <img
                                            ...
                                            {/* Quote */}
                                            <div className="w-full lg:w-3/5 flex flex-col justify-center p-6 md:p-8 bg-gray-50 rounded-xl shadow-md">
                                                <FaQuoteLeft className="text-amber-500 text-3xl md:text-4xl mb-4 md:mb-6" />
                                                <p className="text-gray-700 text-base md:text-lg lg:text-xl mb-6 md:mb-8 leading-relaxed">
                                                    "{testimonial.quote}"
                                                </p>
                                                <div>
                                                    <h4 className="font-bold text-lg md:text-xl text-gray-900">{testimonial.name}</h4>
                                                    <p className="text-amber-500 text-sm md:text-base">{testimonial.role}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <button
                                onClick={nextSlide}
                                className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 md:w-12 md:h-12 rounded-full bg-white shadow-lg flex items-center justify-center text-amber-500 hover:bg-amber-500 hover:text-white transition-all duration-300 transform hover:scale-110"
