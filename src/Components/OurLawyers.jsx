...
const OurLawyers = () => {
    ...
    return (
        <div 
            ref={sectionRef}
            className="w-full md:w-[80%] mx-auto py-16 bg-white"
        >
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <h1 
                        ref={titleRef}
                        className="text-amber-500 text-3xl md:text-4xl font-bold font-inria mb-4 opacity-0"
                    >
                        Our Lawyers
                    </h1>
                    <div className='w-full flex flex-col md:flex-row justify-center items-center mb-6'>
                        {/* Decorative SVG - Hidden on mobile for better spacing */}
                        <svg 
                            className="hidden md:block w-24 md:w-40 lg:w-60" 
                            viewBox="0 0 284 87" 
                            fill="none" 
                        ...
                        <p 
                            ref={descRef}
                            className="text-black text-base md:text-lg font-normal font-inria max-w-2xl mx-auto px-4 md:px-8 opacity-0"
                        >
                ...
                >
                        ...
                        >
                            {lawyers.map((lawyer, index) => (
                                <div
                                    ...
                                    className="w-full md:w-1/3 px-4 flex-shrink-0 opacity-0"
                                >
                                    <div className="bg-white rounded-lg overflow-hidden shadow-lg mb-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                                        ...
                                        <div className="p-6 text-center">
                                            ...
                                            <p className="text-amber-500 text-sm">{lawyer.designation}</p>
                                        </div>
                                    </div>
                                </div>
                            ))}
                    ...
                    <div className="flex justify-center mt-8 space-x-4">
                        <button
                            onClick={prevSlide}
                            className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-gray-100 hover:bg-amber-500 text-amber-500 hover:text-white flex items-center justify-center transition-all duration-300 transform hover:scale-110"
                        ...
                        <div className="flex items-center space-x-2">
                            {Array.from({ length: totalSlides }).map((_, index) => (
                                <button
                                    ...
                                    className={`w-3 h-3 rounded-full transition-all duration-300 ${currentSlide === index ? 'bg-amber-500 scale-125' : 'bg-gray-300'}`}
