...
const Hero = () => {
    ...
    return (
        ...
        >
            ...
            <svg className='absolute top-0 left-0 translate-x-1/4 sm:translate-x-1/3 md:left-[400px] w-48 sm:w-64 md:w-80 lg:w-auto' width="764" height="982" viewBox="0 0 764 982" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5.54556 995.022C-49.705 825.463 11.7719 737.299 189.976 730.528C368.181 723.756 429.657 635.592 374.407 466.033C319.156 296.475 380.633 208.31 558.838 201.539C737.042 194.768 798.519 106.603 743.268 -62.9548" stroke="#E5E5E5" strokeOpacity="0.11" />
            </svg>
            ...
            >
                ...
                >
                    <div className="relative w-full max-w-md">
                        <div className="w-full h-56 sm:h-64 md:h-72 lg:h-80 xl:h-96 bg-gradient-to-r from-[#FCA311] to-[#E5E5E5] rounded-lg flex items-center justify-center overflow-hidden">
                            <img src='https://static.vecteezy.com/system/resources/previews/012/169/097/large_2x/judge-gavel-with-justice-lawyers-having-team-meeting-at-law-firm-in-background-concepts-of-law-free-photo.jpg' className="w-full h-full object-cover" alt='hero image' />
                        </div>
                    </div>
                </div>
            </div>
